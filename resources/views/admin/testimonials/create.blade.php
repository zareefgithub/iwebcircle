...
<div class="max-w-4xl">
    ...
    <form action="{{ route('admin.testimonials.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        @csrf
        ...
        <div class="mb-6">
            ...
            <input type="text" name="client_company" id="client_company" value="{{ old('client_company') }}" required 
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
        </div>
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-gray-500">What the client said about your service</p>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="file" name="client_image" id="client_image" accept="image/*"
                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            <p class="mt-1 text-sm text-gray-500">Optional - photo of the client</p>
        </div>
