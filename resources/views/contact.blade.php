                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-4">
                            ...
                            <div class="flex space-x-3">
                                ...
                                @endif
                                @if(isset($settings['social_github_url']) && $settings['social_github_url']->value)
                                    <a href="{{ $settings['social_github_url']->value }}" target="_blank" class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center hover:bg-gray-800 hover:text-white transition">
                                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="aspect-video bg-gradient-to-br from-blue-100 to-purple-100 rounded-2xl flex items-center justify-center">
            <div class="text-center">
                ...
                <p class="text-gray-600">Map placeholder - Integrate with Google Maps or similar service</p>
            </div>
        </div>
    </div>
</section>
